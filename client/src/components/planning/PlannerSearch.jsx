...
// //       loadMapScript(
// //         `https://maps.googleapis.com/maps/api/js?key=${API_KEY_HERE}&libraries=places`,
...
//       <Grid item sx={{ display: 'flex', width: 44 }} xs={6} className='grid_search' style={{ midWidth: '200px' }}>
